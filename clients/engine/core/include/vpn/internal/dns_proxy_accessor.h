...
public:
    ...
    /** Resolve a hostname through this proxy's configured upstreams, trying the preferred address family first. */
    std::optional<SocketAddress> resolve_hostname(std::string_view hostname, bool prefer_ipv6);
