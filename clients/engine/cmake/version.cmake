...
#   3. git describe --tags --match 'client-v*' (client tags are namespaced);
...
# 3. Client-tag describe (no .git or matching tag -> falls through to step 4).
if (_tt_version STREQUAL "")
    find_package(Git QUIET)
    if (GIT_FOUND)
        execute_process(
            COMMAND "${GIT_EXECUTABLE}" describe --tags --match "client-v*"
        ...
        if (_tt_git_result EQUAL 0 AND NOT _tt_git_describe STREQUAL "")
            string(REGEX REPLACE "^client-v" "" _tt_version "${_tt_git_describe}")
        endif ()
    endif ()
endif ()
...
if (_tt_version STREQUAL "")
    ...
    message(WARNING "TT_CLIENT_VERSION not provided and no client tag was found; "
