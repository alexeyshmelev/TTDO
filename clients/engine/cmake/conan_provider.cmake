set(CONAN_MINIMUM_VERSION 2.31.1)
...
function(conan_install)
    ...
    set(_CONAN_LOCKFILE "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../conan.lock")
    if(EXISTS "${_CONAN_LOCKFILE}")
        list(APPEND CONAN_ARGS "--lockfile=${_CONAN_LOCKFILE}")
    endif()
    ...
    if(NOT "${return_code}" STREQUAL "0")
        ...
        set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${_CONAN_LOCKFILE}")
        # success
        set_property(GLOBAL PROPERTY CONAN_INSTALL_SUCCESS TRUE)
    endif()
    unset(_CONAN_LOCKFILE)
endfunction()
...
macro(conan_provide_dependency method package_name)
    ...
    if(NOT _conan_install_success)
        ...
        if(NOT _multiconfig_generator)
            ...
            conan_install(${_host_profile_flags} ${_build_profile_flags} "--build=*" ${generator})
        else()
            message(STATUS "CMake-Conan: Installing both Debug and Release")
            conan_install(${_host_profile_flags} ${_build_profile_flags} -s build_type=Release "--build=*" ${generator})
            conan_install(${_host_profile_flags} ${_build_profile_flags} -s build_type=Debug "--build=*" ${generator})
        endif()
