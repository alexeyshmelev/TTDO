...
class NGHttp2Conan(ConanFile):
    ...
    def source(self):
        get(
            self,
            url="https://github.com/nghttp2/nghttp2/archive/80d05fe917e428923e0ab654d18f958e49b3db0a.tar.gz",
            sha256="4281b1a29391798e664fd4eb8c42917cdfa73f2b8b6436ee6241b75eba4f9ca5",
