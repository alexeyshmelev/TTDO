...
class QuicheConan(ConanFile):
    ...
    def source(self):
        get(
            self,
            url="https://github.com/cloudflare/quiche/archive/adca4bc48b2061e92cbc6faa4ec972da7e356b5b.tar.gz",
            sha256="5b696765f803eff84f3ff961d2d2a1995bbf4458ac1a305cc085053ee1913f26",
