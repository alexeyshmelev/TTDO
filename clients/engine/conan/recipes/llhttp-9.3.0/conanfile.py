...
class LlhttpParserConan(ConanFile):
    ...
    def source(self):
        get(self,
            url="https://github.com/nodejs/llhttp/archive/86b83a59786caebd581f38d613c64c9e8c52c79e.tar.gz",
            sha256="a02db5cbc702fe8abfe439757dd4ee01e3b737cbb00febf9f842df2a8108ee39",
            strip_root=True)
