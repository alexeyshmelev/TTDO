...
class LdnsConan(ConanFile):
    ...
    def source(self):
        get(
            self,
            url="https://github.com/NLnetLabs/ldns/archive/7128ef56649e0737f236bc5d5d640de38ff0036d.tar.gz",
            sha256="bc7b79ef30c998dd10f09311cb645f44befed41f55ac8ea4b41af1aa9bc0ac60",
            destination="ldns",
            strip_root=True,
        )
