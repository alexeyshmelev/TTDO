...
from conan.tools.files import apply_conandata_patches, chdir, copy, export_conandata_patches, get, rename, replace_in_file, rmdir, save, patch
...
class OpenSSLConan(ConanFile):
    ...
    def source(self):
        get(
            self,
            url="https://github.com/quictls/openssl/archive/cb6841b741544bfd8868c1641ce96a934985509e.tar.gz",
            sha256="1f74c7de1b89bb53ca387f37c8cf4e23535ef20f1190e6d686936775c1ce76bd",
            strip_root=True,
        )
