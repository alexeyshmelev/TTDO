...
class Ngtcp2Conan(ConanFile):
    ...
    def source(self):
        get(
            self,
            url="https://github.com/ngtcp2/ngtcp2/archive/e816023880cfc613309c925ea6dad6ed9ec72ed4.tar.gz",
            sha256="eea155f4df309fb6d2d7cede93071519acc6191490135dce2993add00907cf54",
