...
class AdaConan(ConanFile):
    ...
    def validate(self):
        ...
        if (
            ...
            raise ConanInvalidConfiguration(
                f"{self.ref} requires <charconv>; use libc++ or upgrade the compiler."
            )

    def source(self):
        get(
            self,
            url="https://github.com/ada-url/ada/archive/e0eacf5809e2e14a7be1b7101b59aeb68845aa08.tar.gz",
            sha256="803f8f308afff29b02ae76c8be5e34989bc4028aae5ede8f86c0535b48d93989",
            strip_root=True,
        )
    ...
    def generate(self):
        ...
        toolchain.variables["ADA_TOOLS"] = False
        toolchain.generate()
